...
def_opts = rmtpp_decrnn_vae.rmtpp_decrnn_vae_core.def_opts
...
def cmd(dataset_name, alg_name, dataset_path,
    ...
    def model_creator(params):
        ...
        #rmtpp_decrnn_vae.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.

        hidden_layer_size, wt_hparam, restart, num_epochs, save_dir, train_eval = params
        rmtpp_decrnn_vae_mdl = rmtpp_decrnn_vae.rmtpp_decrnn_vae_core.RMTPP_DECRNN_VAE(
            sess=sess,
