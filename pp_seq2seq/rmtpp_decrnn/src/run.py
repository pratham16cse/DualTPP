...
#        train_time_preds, train_event_preds = rmtpp_decrnn_mdl.predict_train(data=data)
...
#        rmtpp_decrnn_mdl.eval(train_time_preds, gold_train_time_out_seq,
#                       train_event_preds, data['train_event_out_seq'])
#        print()
#
#    if test_eval:
#        print('\nEvaluation on testing data:')
#        test_time_preds, test_event_preds = rmtpp_decrnn_mdl.predict_test(data=data)
#        # Renormalizing the time
#        minTime, maxTime = data['minTime'], data['maxTime']
...
#        print('Decoding Done ------------------------')
#        rmtpp_decrnn_mdl.eval(test_time_preds, gold_test_time_out_seq,
