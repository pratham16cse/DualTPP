#!/usr/bin/env python
import click
import rmtpp_decrnn_constraint
...
def_opts = rmtpp_decrnn_constraint.rmtpp_decrnn_constraint_core.def_opts
...
def cmd(dataset_name, alg_name,
    ...
    data = rmtpp_decrnn_constraint.utils.read_seq2seq_data(
    ...
    def hyperparameter_worker(params):
        ...
        #rmtpp_decrnn_constraint.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.

        hidden_layer_size, restart, num_epochs, save_dir = params
        rmtpp_decrnn_constraint_mdl = rmtpp_decrnn_constraint.rmtpp_decrnn_constraint_core.RMTPP_DECRNN(
            sess=sess,
            ...
            cpu_only=cpu_only,
            _opts=rmtpp_decrnn_constraint.rmtpp_decrnn_constraint_core.def_opts
        )
        ...
        # saving the model.
        rmtpp_decrnn_constraint_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_constraint_mdl.train(training_data=data, restart=restart,
