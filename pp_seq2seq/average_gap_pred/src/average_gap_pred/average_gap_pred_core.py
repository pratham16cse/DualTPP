...
def_opts = Deco.Options(
    ...
    seed=42,
    scope='AVERAGE_GAP_PRED',
    save_dir='./save.average_gap_pred/',
    summary_dir='./summary.average_gap_pred/',
...
class AVERAGE_GAP_PRED:
    ...
    def train(self, training_data, num_epochs=1,
              ...
              restore_path=None, dec_len_for_eval=0, with_evals=False):
        ...
        if self.STOP_CRITERIA == 'epsilon' or True:
            print('w:', self.sess.run(self.wt).tolist())
    ...
    def predict(self, event_in_seq, time_in_seq, decoder_length, plt_tru_gaps, single_threaded=False, plot_dir=False):
        ...
        return time_out_seq, event_out_seq
