...
def_opts = rmtpp_mode.rmtpp_mode_core.def_opts
...
def cmd(dataset_name, alg_name,
    ...
    def hyperparameter_worker(params):
        ...
        #rmtpp_mode.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.

        hidden_layer_size, restart, num_epochs, save_dir, with_evals = params
        rmtpp_mode_mdl = rmtpp_mode.rmtpp_mode_core.RMTPP(
            sess=sess,
        ...
        # saving the model.
        rmtpp_mode_mdl.initialize(finalize=False)
