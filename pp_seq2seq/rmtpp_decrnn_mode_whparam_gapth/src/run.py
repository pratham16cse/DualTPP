#!/usr/bin/env python
import click
import rmtpp_decrnn_mode_whparam_gapth
...
def_opts = rmtpp_decrnn_mode_whparam_gapth.rmtpp_decrnn_mode_whparam_gapth_core.def_opts
...
def cmd(dataset_name, alg_name,
    ...
    data = rmtpp_decrnn_mode_whparam_gapth.utils.read_seq2seq_data(
    ...
    def hyperparameter_worker(params):
        ...
        #rmtpp_decrnn_mode_whparam_gapth.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.

        hidden_layer_size, w = params
        rmtpp_decrnn_mode_whparam_gapth_mdl = rmtpp_decrnn_mode_whparam_gapth.rmtpp_decrnn_mode_whparam_gapth_core.RMTPP_DECRNN(
            sess=sess,
            ...
            cpu_only=cpu_only,
            _opts=rmtpp_decrnn_mode_whparam_gapth.rmtpp_decrnn_mode_whparam_gapth_core.def_opts
        )
        ...
        # saving the model.
        rmtpp_decrnn_mode_whparam_gapth_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_mode_whparam_gapth_mdl.train(training_data=data, restart=restart,
