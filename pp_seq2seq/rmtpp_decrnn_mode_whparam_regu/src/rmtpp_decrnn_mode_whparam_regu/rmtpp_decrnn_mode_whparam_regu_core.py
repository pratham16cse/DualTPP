        ...
        for epoch in range(self.last_epoch, self.last_epoch + num_epochs):
            ...
            if with_evals:
                ...
                if dev_mae < best_dev_mae:
                    ...
                    best_w = self.wt
                    best_l2penalty = self.L2_PENALTY

                    checkpoint_dir = os.path.join(self.SAVE_DIR, 'hls_'+str(self.HIDDEN_LAYER_SIZE)+'_wt_'+str(self.wt)+'_l2penalty_'+str(self.L2_PENALTY))
