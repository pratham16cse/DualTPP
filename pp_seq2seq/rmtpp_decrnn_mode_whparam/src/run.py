#!/usr/bin/env python
import click
import rmtpp_decrnn_mode_whparam
...
def cmd(dataset_name, alg_name,
    ...
    data = rmtpp_decrnn_mode_whparam.utils.read_seq2seq_data(
    ...
    def hyperparameter_worker(params):
        ...
        rmtpp_decrnn_mode_whparam_mdl = rmtpp_decrnn_mode_whparam.rmtpp_decrnn_mode_whparam_core.RMTPP_DECRNN(
            ...
            cpu_only=cpu_only,
            _opts=rmtpp_decrnn_mode_whparam.rmtpp_decrnn_mode_whparam_core.def_opts
        )
        ...
        # saving the model.
        rmtpp_decrnn_mode_whparam_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_mode_whparam_mdl.train(training_data=data, restart=restart,
