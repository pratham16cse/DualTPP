...
def_opts = rmtpp_decrnn_pre.rmtpp_decrnn_pre_core.def_opts
...
def cmd(dataset_name, alg_name, dataset_path,
    ...
    data = rmtpp_decrnn_pre.utils.read_seq2seq_data(
    ...
    def model_creator(params):
        ...
        #rmtpp_decrnn_pre.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.
        ...
        rmtpp_decrnn_pre_mdl = rmtpp_decrnn_pre.rmtpp_decrnn_pre_core.RMTPP_DECRNN_PRE(
            sess=sess,
        ...
        return rmtpp_decrnn_pre_mdl

    def hyperparameter_worker(params, rmtpp_decrnn_pre_mdl, dec_len, restore_path=None):
        ...
        # saving the model.
        rmtpp_decrnn_pre_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_pre_mdl.train(training_data=data, restart=restart,
    ...
    decoder_length_run = [0, 1, 2, 3, 4, 5]
    ...
    for dec_len in decoder_length_run:
        ...
        if os.path.isfile(save_dir+'/result.json'):
            ...
            rmtpp_decrnn_pre_mdl = model_creator(args)
            result = hyperparameter_worker(args, rmtpp_decrnn_pre_mdl, dec_len)
        else:
            ...
            if parallel_hparam:
                ...
                def hparam_loop(all_params):
                    ...
                    rmtpp_decrnn_pre_mdl = model_creator(args)
                    result = hyperparameter_worker(args, rmtpp_decrnn_pre_mdl, dec_len, checkp_dir)
