...
from .utils import create_dir, variable_summaries, MAE, RMSE, ACC
...
class RMTPP:
    ...
    def predict(self, event_in_seq, time_in_seq, decoder_length, single_threaded=False):
        ...
        for pred_idx in range(0, decoder_length):
            ...
            all_event_preds.extend([np.argmax(bptt_events_pred[-1], axis=-1)])
    ...
    def eval(self, time_preds, time_true, event_preds, event_true):
        ...
        print('** RMSE = {}; valid = {}, ACC = {}'.format(
            rmse, total_valid, ACC(event_preds, event_true)))
