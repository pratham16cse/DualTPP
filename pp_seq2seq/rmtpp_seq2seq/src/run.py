...
def cmd(event_train_file, time_train_file, event_test_file, time_test_file,
    ...
    data = tf_rmtpp.utils.read_seq2seq_data(
    ...
    #tf_rmtpp.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.
    ...
    if test_eval:
        ...
        print('Decoding Done ------------------------')
        print(data['test_time_out_seq'].shape, test_time_preds.shape)
        print(data['test_event_out_seq'].shape, test_event_preds.shape)
