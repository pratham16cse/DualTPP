#!/usr/bin/env python
import click
import rmtpp_decrnn_mode_whparam_gapthregu
...
def cmd(dataset_name, alg_name,
    ...
    data = rmtpp_decrnn_mode_whparam_gapthregu.utils.read_seq2seq_data(
    ...
    def hyperparameter_worker(params):
        ...
        #rmtpp_decrnn_mode_whparam_gapthregu.utils.data_stats(data) #TODO(PD) Need to support seq2seq models.

        hidden_layer_size, w = params
        rmtpp_decrnn_mode_whparam_gapthregu_mdl = rmtpp_decrnn_mode_whparam_gapthregu.rmtpp_decrnn_mode_whparam_gapthregu_core.RMTPP_DECRNN(
            sess=sess,
            ...
            cpu_only=cpu_only,
            _opts=rmtpp_decrnn_mode_whparam_gapthregu.rmtpp_decrnn_mode_whparam_gapthregu_core.def_opts
        )
        ...
        # saving the model.
        rmtpp_decrnn_mode_whparam_gapthregu_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_mode_whparam_gapthregu_mdl.train(training_data=data, restart=restart,
