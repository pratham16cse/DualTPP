...
def_opts = rmtpp_decrnn_mode_cf.rmtpp_decrnn_mode_cf_core.def_opts
...
def cmd(dataset_name, alg_name,
    ...
    data = rmtpp_decrnn_mode_cf.utils.read_seq2seq_data(
    ...
    def hyperparameter_worker(params):
        ...
        rmtpp_decrnn_mode_cf_mdl = rmtpp_decrnn_mode_cf.rmtpp_decrnn_mode_cf_core.RMTPP_DECRNN(
            ...
            cpu_only=cpu_only,
            _opts=rmtpp_decrnn_mode_cf.rmtpp_decrnn_mode_cf_core.def_opts
        )
        ...
        # saving the model.
        rmtpp_decrnn_mode_cf_mdl.initialize(finalize=False)
        result = rmtpp_decrnn_mode_cf_mdl.train(training_data=data, restart=restart,
